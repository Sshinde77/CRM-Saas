            ...
            child: Column(
              ...
              children: [
                ...
                _CardContainer(
                  ...
                  child: _buildFinancialYearSection(),
                ),
                const SizedBox(height: 16),
                _CardContainer(
                  borderRadius: 24,
                  padding: const EdgeInsets.all(20),
                  child: _buildGstSection(),
                ),
                const SizedBox(height: 16),
                _CardContainer(
                  borderRadius: 24,
                ...
                _CardContainer(
                  borderRadius: 24,
                  padding: const EdgeInsets.all(20),
                  child: _buildNotificationPrefsSection(),
                ),
              ],
            ),
          ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: _saving
                ...
                : const Text('Save Settings', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w700)),
          ),
        ),
      ],
    );
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: _gstOptions.map((rate) => DropdownMenuItem(value: rate, child: Text(rate))).toList(),
              onChanged: (value) {
